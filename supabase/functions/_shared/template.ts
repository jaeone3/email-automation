...
<body style="margin:0; padding:0; background-color:#ffffff; font-family:-apple-system,'Apple SD Gothic Neo','Malgun Gothic','Noto Sans KR','Helvetica Neue',sans-serif;">
...
<table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; max-width:600px;">
  ...
  <!-- 주간 캘린더 -->
  <tr>
    <td style="padding:20px 70px 32px 70px;">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center" style="font-size:13px; font-weight:500; color:#afafaf; padding:8px 0 8px 0;">금</td>
          <td align="center" style="font-size:13px; font-weight:500; color:#afafaf; padding:8px 0 8px 0;">토</td>
          <td align="center" style="font-size:13px; font-weight:500; color:#afafaf; padding:8px 0 8px 0;">일</td>
          <td align="center" style="font-size:13px; font-weight:500; color:#afafaf; padding:8px 0 8px 0;">월</td>
          <td align="center" style="font-size:13px; font-weight:500; color:#afafaf; padding:8px 0 8px 0;">화</td>
          <td align="center" style="font-size:13px; font-weight:500; color:#afafaf; padding:8px 0 8px 0;">수</td>
          <td align="center" style="font-size:13px; font-weight:500; color:#afafaf; padding:8px 0 8px 0;">목</td>
        </tr>
        <tr>
          <td align="center" style="padding:4px;"><span style="display:inline-block; width:34px; height:34px; border-radius:50%; background-color:#e0e0e0;">&nbsp;</span></td>
          <td align="center" style="padding:4px;"><span style="display:inline-block; width:34px; height:34px; border-radius:50%; background-color:#e0e0e0;">&nbsp;</span></td>
          <td align="center" style="padding:4px;"><span style="display:inline-block; width:34px; height:34px; border-radius:50%; background-color:#e0e0e0;">&nbsp;</span></td>
          <td align="center" style="padding:4px;"><span style="display:inline-block; width:34px; height:34px; border-radius:50%; background-color:#e0e0e0;">&nbsp;</span></td>
          <td align="center" style="padding:4px;"><span style="display:inline-block; width:34px; height:34px; border-radius:50%; background-color:#e0e0e0;">&nbsp;</span></td>
          <td align="center" style="padding:4px;"><span style="display:inline-block; width:34px; height:34px; border-radius:50%; background-color:#e0e0e0;">&nbsp;</span></td>
          <td align="center" style="padding:4px;"><span style="display:inline-block; width:34px; height:34px; border-radius:50%; border:2px dashed #FF9600; background-color:#ffffff;">&nbsp;</span></td>
        </tr>
      </table>
    </td>
  </tr>
